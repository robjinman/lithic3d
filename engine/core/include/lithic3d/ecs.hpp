...
// are prefixed with D, e.g. DSpatial. These classes should define an inner type called
// RequiredComponents of type type_list<...> in which required components are listed.
//
